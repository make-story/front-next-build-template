...
// 각 영역 상태 초기값
import { initialState as moduleInit } from '@src/project/stores/module/reducer';
import { initialState as testInit } from '@src/project/stores/test/reducer';

// common
import loading from '@src/common/stores/loading/reducer';

// project
import moduleReducer from '@src/project/stores/module/reducer'; // import module from ... 할 경우, webpack module 와 겹쳐서 에러발생
import test from '@src/project/stores/test/reducer';
...
const rootReducer = (state: any, action: AnyAction) => {
  ...
  if (action.type === HYDRATE) {
    ...
    setClientSide('module', moduleInit);
